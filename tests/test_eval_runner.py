"""CSV eval runner: teach replay, hit scoring (TP/FP/FN), and SKIP-without-key."""
...
def test_useful_apply_scores_a_true_positive_hit() -> None:
    ...
    result = run_case_row(case, teaches)
...
def test_requires_llm_row_is_skipped_without_a_key(monkeypatch) -> None:
